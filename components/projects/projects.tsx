         ...
         <div className='pt-12 mx-2 space-y-14'>
            ...
            >
               ...
               <motion.div whileHover={{y:-7, z:-1, transition: {duration: 0.2, ease: "easeInOut" }}} className='flex items-center justify-center w-full h-full col-span-1 text-center rounded-md cursor-pointer dark:bg-light_primary bg-dark_primary'>
                  <img className='w-auto h-72' src="/projectIcons/dashboard.png" alt="icon" />
               </motion.div>
            </motion.div>
            ...
            >
               <motion.div whileHover={{y:-7, z:-1, transition: {duration: 0.2, ease: "easeInOut" }}} className='flex items-center justify-center w-full h-full col-span-1 text-center rounded-md cursor-pointer dark:bg-light_primary bg-dark_primary'>
                  <img className='w-72 h-72' src="/projectIcons/music.png" alt="icon" />
               </motion.div>
            ...
            >
               ...
               <motion.div whileHover={{y:-7, z:-1, transition: {duration: 0.2, ease: "easeInOut" }}} className='flex items-center justify-center w-full h-full col-span-1 text-center rounded-md cursor-pointer dark:bg-light_primary bg-dark_primary'>
                  <img className='w-auto h-72' src="/projectIcons/todolist.png" alt="icon" />
               </motion.div>
            </motion.div>
            ...
            >
               ...
               <motion.div whileHover={{y:-7, z:-1, transition: {duration: 0.2, ease: "easeInOut" }}} className='flex items-center justify-center w-full h-full col-span-1 text-center rounded-md cursor-pointer dark:bg-light_primary bg-dark_primary'>
                  <img className='h-72' src="/projectIcons/arbis.png" alt="icon" />
               </motion.div>
            </motion.div>

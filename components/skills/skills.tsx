...
const Skills = () => {
  return (
    <motion.div
      ...
      className="px-6 pt-12 text-black cursor-default dark:text-light_primary font-Rubik"
    >
      ...
      <h3 className="px-2 pt-5 text-2xl font-semibold text-light_gray_custom dark:text-dark_gray_custom">
        I am passionate about learning powerful and cutting-edge technologies.
        These are the tools I am most familiar with and use every day.
      </h3>
      <div className="grid max-w-md grid-cols-3 grid-rows-2 gap-6 px-2 py-8 overflow-hidden">
          ...
          <Link href="https://www.typescriptlang.org/">
            <a target="_blank">
              <div className="flex-inline w-min">
                ...
                <span className="m-auto font-semibold md:text-xl text-dark_secondary dark:text-light_secondary">
                  TypeScript
                </span>
              </div>
            </a>
          ...
          <Link href="https://reactjs.org/">
            <a target="_blank">
              <div className="flex-inline w-min">
                ...
                <span className="px-1 m-auto font-semibold w-min md:text-xl text-dark_secondary dark:text-light_secondary">
                  React
                </span>
              </div>
            </a>
        ...
        >
          <Link href="https://redis.io/">
            <a target="_blank">
              <div className="flex-inline w-min">
                <div className="py-1 m-auto text-5xl w-min text-redis_color">
                  <SiRedis />
                </div>
                <span className="m-auto font-semibold w-min md:text-xl text-dark_secondary dark:text-light_secondary">
                  Redis
